...
const Pumpay = () => {
  ...
  const responsibilities = [
    {
      description:
        "Leading a team of Developers in building the mobile app for android and iOS devices",
    },
    {
  ...
  return (
    <div className="bg-gradient-to-br from-black via-[#000] to-black text-[#ECE7E1] font-poppins">
      <div className="lg:px-0 max-w-7xl mx-auto pt-32">
        ...
        >
          <h1 className="text-4xl lg:text-8xl font-bold text-white">Pumpay</h1>
          <p className="text-neutral-500 text-lg max-w-6xl">
            Pumpay is a Fuel Delivery Service that allows users to conveniently
            order fuel to be delivered directly to their location, providing a
            hassle-free and efficient fueling experience.
          </p>
          <span className="border-l-2 border-red-500 pl-4 text-md lg:text-xl text-neutral-500">
            Stacks Used: Next.js, TypeScript, Tailwind CSS, Git/GitHub, React
            Hooks, React Native, Node.js, Express.js, Postgresql, Paystack API, Google Maps API.
          </span>
        </motion.header>
        ...
        >
          ‼️The Organizations repository is Private
        </motion.div>
      </div>
