...
const WebInfluencers = () => {
  ...
  const features = [
    {
      title: "Strategic Communications and PR",
    },
    {
      title: "AI Venture Studio",
    },
    {
      title: "Global Talent Platforms",
    },
  ];
      ...
      <div className="lg:px-0 max-w-7xl mx-auto pt-32">
        ...
        >
          ...
          <p className="text-neutral-500 text-lg max-w-6xl">
            From strategic communications and AI innovation to talent platforms
            and media publishing, we create impactful digital solutions that
            bridge markets and connect communities worldwide.
          </p>
          <span className="border-l-2 border-red-500 pl-4 text-md lg:text-xl text-neutral-500">
            Stacks Used: Next.js, TypeScript, Tailwind CSS, React Hooks, Git/GitHub.
          </span>
        </motion.header>
