...
const Ekhostudios = () => {
  ...
  const responsibilities = [
    ...
    // {
    //   description: "Added the currency converter feature.",
    // },
  ];
      ...
      <div className="lg:px-0 max-w-7xl mx-auto pt-32">
        ...
        >
          ...
          <p className="text-neutral-500 text-lg max-w-6xl">
            Ekhostudios is a creative agency that specializes creating cinematic
            product videos.
          </p>
          <span className="border-l-2 border-red-500 pl-4 text-md lg:text-xl text-neutral-500">
            Stacks Used: Next.js, TypeScript, Tailwind CSS, Git/GitHub, Framer
            Motion, Gsap Animation Library.
          </span>
        </motion.header>
        ...
        >
          <a
            href="https://github.com/Kijedev/ken-williams-portfolio"
            target="_blank"
